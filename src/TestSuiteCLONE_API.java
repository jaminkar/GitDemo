...
public class TestSuiteCLONE_API {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.crome.driver", "D:\\chrome-win64\\chrome-win64");
		{
			...
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
			driver.findElement(By.xpath("(//i[@class='fa-solid fa-ellipsis-vertical fa-lg'])[2]")).click();
			System.out.println("Clicked on 3 dots");
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
			driver.findElement(By.xpath("//i[@class='fa-light fa-copy']")).click();
			System.out.println("API Cloned");
