...
public class TestSuite_ExecuteFunctional {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.crome.driver", "D:\\chrome-win64\\chrome-win64");
		{
			...
			driver.findElement(By.xpath("//i[@class='fa-light fa-brackets-curly']")).click();
			System.out.println("Clicked on Functional");
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
			driver.findElement(By.xpath("//i[@class='fa-regular fa-arrows-rotate ng-star-inserted']")).click();
			System.out.println("Clicked On Refresh on Report page");
